 ...
 * 
 */
package com.formation.commande.application;

import com.formation.commande.modele.bo.Article;
import com.formation.commande.modele.bo.Catalogue;
import com.formation.commande.modele.bo.Panier;
import com.formation.commande.modele.bo.Ramette;
import com.formation.commande.modele.bo.Stylo;
...
public class AppliTestBO {
	...
	public static void main(String[] args) {
		...
		try {
			//?? l'ajout d'une ligne dans le panier, le stock virtuel de l'article doit diminuer
		...
		try {
			...
			//tester le d??passement de qt?? en stock (la ligne n'est pas ajout??e au panier)
		...
		try {
			...
			//on r??affiche le catalogue (les stocks sont ?? jour)
			Catalogue catalogue = new Catalogue(articles);
			System.out.println(catalogue.toString());		
			System.out.println("---------------------------------------------------------------");
		}  catch (Exception e) {
